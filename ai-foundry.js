...
export async function main() {
  ...
  const endpoint = process.env["AZURE_OPENAI_ENDPOINT"] || "https://aistudioaiservices024520298838.openai.azure.com/";
  const apiKey = process.env["AZURE_OPENAI_API_KEY"] || "<REPLACE_WITH_YOUR_KEY_VALUE_HERE>";
  const apiVersion = "2025-01-01-preview";
  const deployment = "gpt-4o_AIFoundary"; // This must match your deployment name
